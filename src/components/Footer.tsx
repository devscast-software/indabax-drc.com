function FooterSocialLink() {
    return (
        <div className="my-8 flex justify-center gap-4">
            <a href="" rel="noopener" target="_blank" aria-label="youtube" className="text-white hover:text-primary">
            ...
            <a href="" rel="noopener" target="_blank" aria-label="instagram" className="text-white hover:text-primary">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="h-5" viewBox="0 0 16 16">
            ...
            <a href="" rel="noopener" target="_blank" aria-label="twitter" className="text-white hover:text-primary">
