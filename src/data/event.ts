...
export default {
    ...
    speakers: [
        {name: 'Antoine Bagula, PhD', role: 'Speaker', organization: 'University of Western Cape', image: '/organizers/634d5fed05733262169654.jpg', link: 'https://www.linkedin.com/in/antoine-bagula-2075305/?originalSubdomain=za', country: 'sa'},
        {name: 'Meshia Cédric Oveneke, PhD', role: 'Speaker', organization: 'Neotex.ai', image: '/organizers/64355d8597a5c676189023.jpeg', link: 'https://www.linkedin.com/in/meshiacedricoveneke/?originalSubdomain=be', country: 'sa'},
        ...
        {name: 'Diana Pholo', role: 'Speaker', organization: 'Predictive Insights', image: '/organizers/648620f2f3694268247135.jpeg', link: 'https://www.linkedin.com/in/diana-pholo-moanda-76ba803b/', country: 'sa'},
        {name: 'Junior Muka', role: 'Speaker', organization: 'Woolworth South Africa', image: '/organizers/6478daaf554f3616239108.jpeg', link: 'https://www.linkedin.com/in/junior-muka-aa0b0b7/', country: 'sa'},
    ]
}
